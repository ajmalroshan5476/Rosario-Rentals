...
import api from '../../api/api.js'; // ✅ Corrected import
...
const Sidebar = () => {
    ...
    const updateImage = async () => {
        try {
            ...
            const { data } = await api.post('/api/owner/update-image', formData); // ✅ Corrected usage
        ...
        <div className='relative min-h-screen md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
            ...
            {image && (
                ...
                >
                    ...
                    {!uploading && <img src={assets.check_icon} width={13} alt="" />}
                </button>
            )}
